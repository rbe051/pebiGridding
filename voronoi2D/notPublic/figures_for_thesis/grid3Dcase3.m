...
typeOfGrid = 'distmesh';
name = strcat(typeOfGrid,'case3');
fileFormat = 'pdfNoVector';

%% grid parameters
%[nx,ny,nz] = deal(160,160,10); %fine cart 
%[nx,ny,nz] = deal(40,20,10);%coarse cart
[nx,ny,nz] = deal(20,10,10);%distmesh
%[nx,ny,nz] = deal(10,10,10);%composite
[Lx,Ly,Lz] = deal(400,400,50);

gridSize = norm([Lx,Ly])/norm([nx,ny]);

faultLine = {[10,100;380,380], [20,20;390,300]};
wellLine = {[50,75], [350, 300] };                   % Set source center
...
wellEps = sqrt(gridSize)*5;      % Size around wells to be refined
